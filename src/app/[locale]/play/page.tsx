...
export default function PlayHubPage() {
  ...
  return (
    <div className="flex flex-col px-4 pt-6 pb-24 min-h-screen relative overflow-hidden">
      {/* Subtle Celestial Background Layer */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,_rgba(139,92,246,0.08)_0%,_transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,_rgba(236,72,153,0.05)_0%,_transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,_rgba(245,158,11,0.03)_0%,_transparent_70%)]" />
      ...
      <div className="relative z-10">
        ...
        {/* ... rest of content remains inside ... */}
        ...
        <div className="flex flex-col gap-4 max-w-md mx-auto w-full">
          ...
          <div className="flex flex-col gap-4 mt-2">
            ...
            <motion.button
              ...
              className="relative group w-full text-left overflow-hidden rounded-2xl min-h-[160px] sm:min-h-[200px] shadow-lg"
              style={{
                backgroundImage: 'url(/assets/backgrounds/bg_arena_banner.png)',
                backgroundSize: 'cover',
                backgroundPosition: 'center',
              }}
            >
